...
module boundary_diffusion
 ...
 interface
       ...
       !> client programs
       subroutine boundary_diffusion_matrix_if( center_diag ,      &
                                                      up_diag,          &     
                                                      down_diag,        &
                                                      area,             &
                                                      area_lo,          &
       ...
       end subroutine boundary_diffusion_matrix_if
 end interface

 !> This pointer should be set by the driver or client code to specify the 
 !> treatment at the first and last row of coefficient matrix
 procedure(boundary_diffusion_matrix_if),pointer :: boundary_diffusion_matrix  => null()
