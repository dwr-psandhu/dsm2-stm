...
real(stm_real):: gravity = 9.8d0                  !< Gravity
real(stm_real):: capital_r                        !< Submerged specific gravity of sediment particles  
real(stm_real):: diameter(nsed)                   !< Particle diameter
real(stm_real):: einstein_bedload_num(ncell,nsed) !< Dimensionless belload transport rate 
real(stm_real):: q_sub_b(ncell,nsed)              !< Volumetric bedload transport rate
!----------------
real(stm_real):: hand_calculation(ncell,nsed)
integer :: iclas 
integer :: ivol
